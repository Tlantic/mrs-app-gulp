...
module.exports=(function () {
    ...
    this.globs={
        ...
        styleFiles: [
            this.paths.src.scss.files.deep,
            this.paths.src.css.files.deep,
            this.paths.config.brand.www.scss.files.deep,
            this.paths.config.brand.www.css.files.deep
        ],
        ...
        i18nFiles: [
            this.paths.src.i18n.files.deep + '.*(json)',
            this.paths.config.brand.i18n.files.deep + '.*(json)'
    ...
    this.tasks={
        ...
        'clean': {
            src: [
                this.paths.resources.files.deep,
                this.paths.merge.files.deep,
                this.paths.www.files.deep
            ],
            srcOptions: {
                read: false
            }
        ...
        'build:style': {
            ...
            src: this.paths.merge.www.css.files.deep,
        ...
        'build:style:process': {
            dependencies: [ 'build:style:merge', 'build:lib:merge' ],
            src: this.paths.merge.www.scss.files.deep,
            dest: this.paths.merge.www.css.root
        },

        'build:js': {
            dependencies: [ 'build:js:merge', 'build:js:flatten' ],
            src: this.paths.merge.www.js.files.deep,
        ...
        'build:i18n': {
            ...
            src: this.paths.merge.www.i18n.files.deep + '.*(json)',
        ...
        'build:index-files': {
            dependencies: [ 'build:index-files:merge', 'build:js:flatten', 'build:templates:cache', 'build:style:process' ],
            src: path.join( this.paths.merge.www.root, 'index.html' ),
            dest: this.paths.www.root,
            inject: {
                src: [
                    this.paths.merge.www.js.files.all + '.js',
                    this.paths.merge.www.css.files.all + '.css'
                ],
                srcOptions: { cwd: this.paths.merge.www.root }
            }
        },
