        ...
        try {
            ...
            if ( !( srcObj instanceof Array ) ) {
                return this.emit( 'error',
                    new PluginError( PLUGIN_NAME, 'Error parsing JSON: expecting an JSON array of object, file: ' + gutil.colors.cyan(path.join(file.base, file.relative ))) );
            }
            ...
            return this.emit( 'error',
                new PluginError( PLUGIN_NAME, 'Error parsing JSON: ' + err + ', file: ' + gutil.colors.cyan(path.join(file.base, file.relative ))) );
        }
